...
rankingdf <- read.csv('https://raw.githubusercontent.com/tanho63/dynastyprocess/master/files/fantasypros/ecr_20190829.csv')
...
json_data <- fromJSON('http://fantasy.espn.com/apis/v3/games/ffl/seasons/2019/segments/0/leagues/805175?view=mDraftDetail&view=mLiveScoring&view=mMatchupScore&view=mPendingTransactions&view=mPositionalRatings&view=mSettings&view=mTeam&view=modular&view=mNav', flatten = TRUE)
...
merged <- draftdf %>% 
  ...
  select(Pick = id, Player = fullName,pos = Pos, owner, roECR, pts)
