...
json_data <- fromJSON('http://fantasy.espn.com/apis/v3/games/ffl/seasons/2019/segments/0/leagues/805175?view=mRoster&view=mTeam', flatten = TRUE)
...
merged <- dfRosters %>% 
  ...
  left_join(rankingdf, by=c("fullName"="Player")) %>%
